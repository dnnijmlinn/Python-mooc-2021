...
exercise = 'src.sudoku_tarkistin'
function = 'sudoku_oikein'
...
"""
    ...
    def test_1_funktio_olemassa(self):
        try:
            from src.sudoku_tarkistin import sudoku_oikein
        except:
            self.assertTrue(False, f'Koodistasi pitäisi löytyä funktio nimeltä sudoku_oikein(sudoku: list)')
        try:
            sudoku_oikein = load(exercise, function, 'fi')
            s = sudoku = [
                [ 9, 0, 0, 0, 8, 0, 3, 0, 0 ],
                [ 2, 0, 0, 2, 5, 0, 7, 0, 0 ],
                [ 0, 2, 0, 3, 0, 0, 0, 0, 4 ],
    ...
    def test_3_toiminnallisuus_epavalideilla(self):   
        sudoku_oikein = load(exercise, function, 'fi')
        for s in invalids:
            ps = p(s)
            try:
              ...
              self.assertEqual(val, False, f"Varmista että seuraava kutsu toimii\n{ps}\nsudoku_oikein(sudoku)")
            self.assertEqual(val, False, f"Tulos {val} on väärin kutsuttaessa \n{ps}\nsudoku_oikein(sudoku)")

    def test_4_toiminnallisuus_valideilla(self):   
        sudoku_oikein = load(exercise, function, 'fi')
        for s in valids:
            ps = p(s)
            try:
